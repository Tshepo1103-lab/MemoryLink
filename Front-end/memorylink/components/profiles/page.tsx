...
const ProfilesFC = () => {
  ...
  return (
    <div>
      ...
      <p className={styles.paragraph}>Upload an image to search, or alternatively, try to describe as much as possible. This is an AI search, which works with similarities.</p>
      <div className={styles.searchContainer}>
        ...
        >
          <Form.Item name="value">
            <Input placeholder="Search here" style={{ width: 500, height: 30 }} />
          </Form.Item>
          <Form.Item>
          ...
          <Upload>
            <Button icon={<UploadOutlined />} style={{width:'100px', alignItems:'center', position:'absolute', top:'0'}}/>
          </Upload>
        </Form>
      </div>
