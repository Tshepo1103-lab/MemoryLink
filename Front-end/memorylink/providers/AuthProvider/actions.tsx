...
import { ILoginResponse, IUserResponse, IUserStateContext } from "./context";
...
export const loginSuccessAction = createAction<IUserStateContext,ILoginResponse>(
    UserActionEnum.loginUserSuccess,
    (UserLogin) => ({isPending:false,isError:false,isSuccess:true,UserLogin})
)
