...
import { DesktopOutlined, LogoutOutlined, MenuFoldOutlined, MenuUnfoldOutlined, PieChartOutlined, TransactionOutlined } from '@ant-design/icons';
...
<Layout>
    ...
    <div className={styles.list}>
        ...
        {navLinks.map((link, index) => (
            ...
            <Link href={link.href} className={styles.items}>{link.name}</Link>
            </Menu.Item>
        ))}
        </Menu>
    </div>
