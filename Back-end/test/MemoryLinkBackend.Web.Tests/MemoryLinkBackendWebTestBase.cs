...
{
    public abstract class MemoryLinkBackendWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MemoryLinkBackendWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MemoryLinkBackendWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MemoryLinkBackendDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MemoryLinkBackendDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MemoryLinkBackendDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MemoryLinkBackendDbContext, Task<T>> func)
        {
            T result;
